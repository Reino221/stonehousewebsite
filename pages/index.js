...
export default function Home() {
  ...
  return (
    <div style={{ width: '100%', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end', background: theme === 'dark' ? '#181d23' : '#f7f7f7' }}>
      {/* Mining Logo as background container */}
      <div style={{
        width: '100%',
        display: 'flex',
        ...
        boxShadow: 'none',
        padding: '1.2rem 0 2.5rem 0', // reduced top padding to decrease gap
        marginBottom: '0',
        zIndex: 2,
      }}>
        <div style={{
          position: 'relative',
          width: '100%',
          maxWidth: 1280, // keep width the same
          height: 370, // increase height for a nudge bigger look
          display: 'flex',
          ...
          <img
            ...
            style={{
              ...
              background: theme === 'dark' ? '#232b36' : '#e0e0e0',
            }}
          />
          ...
          <div style={{
            ...
            {/* Quotation buttons inside the Mining Logo */}
            <div className="stonehouse-quote-btn-row" style={{
              display: 'flex',
              flexDirection: 'row',
              justifyContent: 'center',
              alignItems: 'center',
